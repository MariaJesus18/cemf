...
<div class="container-xxl  ">
    ...
    <div class="row justify-content-center align-items-center g-2">
        <div class="col">
            <h1 class="float-start">Anexos de Aluno</h1>
        </div>
    </div>
                        ...
                        <div class="modal-body">
                            <div class="container-xxl">
                                <div class="authentication-wrapper authentication-basic container-p-y">
                                    ...
                                    <form class="" action="studentAttachments" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-xl">
                                                <div class="card-body">
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr class="">
                ...
                <td scope="row">
                    <a href="{{ asset('image/studentAttachments/' . $studentAttachments->file) }}" target="_blank">
                        <img src="{{ asset('image/studentAttachments/' . $studentAttachments->file) }}" alt="{{ $studentAttachments->title }}" style="width: 150px; height: auto;">
                    </a>
                </td>
                <td>{{$studentAttachments->title}}</td>
                <td>
                    <div class="btn-group">
