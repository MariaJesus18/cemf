                        ...
                        <div class="card-body">
                            ...
                            <form id="formAuthentication" class="mb-3" action="{{route('forget.password.post')}}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <small id="helpId" class="form-text text-muted">Insira o email, caso esteja cadastrado no sistema, vai ser enviado um link nesse mesmo email pare alterar a senha.</small>
                                </div>
