...
<body>
    ...
    <div class="container-xxl">
        <div class="authentication-wrapper authentication-basic container-p-y">
                ...
                <!-- Register -->
                <div class="card" style="width: 37.5rem;height: 45.125rem;padding: 2rem;">
                    <div class="card-body">
                        <!-- Logo -->
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{url('register')}}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="phone" name="telephone" value="{{old('telephone')}}"
                            ...
                            <div class="mb-3 form-password-toggle">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" id="password" class="form-control" name="password_confirmation" value="{{old('password_confirmation')}}"
                                        placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                                        aria-describedby="password" />
                                    <span class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>
                                </div>
