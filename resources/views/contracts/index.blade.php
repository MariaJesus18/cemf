                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <button style="background-color: transparent; border:none;" type="button" class="close"
                                                ...
                                                <div class="authentication-wrapper authentication-basic container-p-y">
                                                    ...
                                                    <div class="card mb-4">
                                                        <div class="card-header">
                                                            <button type="submit" name="effect" id="effect"
                                                                class="btn btn-success float-end">Efetivar
                                                                Matricula +</button>
                                                            ...
                                                            <div class="col-xl">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <select class="form-select" id="covenant_id"
                                                                            aria-label="Default select example"
                                                                            name="covenant_id">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label for="school"
                                                                            class="form-label">Escola</label>
                                                                        <select class="form-select" id="school_id"
                                                                            aria-label="Default select example"
                                                                            name="school_id">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label for="responsible"
                                                                            class="form-label">Responsavel pelo
                                                                            pagamento</label>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label for="modality"
                                                                            class="form-label">Modalidade</label>
                                                                        <select class="form-select" id="modality_id"
                                                                            aria-label="Default select example"
                                                                            name="modality_id">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <select class="form-select" id="series_id"
                                                                            aria-label="Default select example"
                                                                            name="serie_id">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        @foreach ($subject as $subjects)
                                                                            <div class="form-check">
                                                                                <input class="form-check-input" type="checkbox" value="{{ $subjects->id }}" id="{{$subjects->id}}" name="subject_id[]">
