...
<div class="container-xxl  ">
    <div class="row justify-content-center align-items-center g-2">
        <div class="col">
            <h1 class="float-start">Fornecedores </h1>
        </div>
    </div>
    <div class="row justify-content-center align-items-center g-2 mb-3">
        <div class="col">
            {{-- <div class="btn-group">
            <a href="{{route('suppliers.index')}}" class="btn btn-outline-white border" style="font-size: 13px">Todos {{\DB::table('suppliers')->count()}}</a>
            <a href="{{route('supplier.activated')}}" class="btn btn-outline-white border" style="font-size: 13px">Ativados {{\DB::table('suppliers')->where('status','=',true)->count()}}</a>
            <a href="{{route('supplier.disabled')}}" class="btn btn-outline-white border" style="font-size: 13px">Suspensos {{\DB::table('suppliers')->where('status','=',false)->count()}}</a>
            <a href="{{route('supplier.disabled')}}" class="btn btn-outline-white border" style="font-size: 13px">Pendentes {{\DB::table('suppliers')->where('status','=',false)->count()}}</a>
            <a href="{{route('supplier.disabled')}}" class="btn btn-outline-white border" style="font-size: 13px">Em atraso {{\DB::table('suppliers')->where('status','=',false)->count()}}</a>
        </div> --}}
    </div>
    <div class="col">
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title h1 text-center" id="TituloModalCentralizado">Adicionar Fornecedor</h5>
