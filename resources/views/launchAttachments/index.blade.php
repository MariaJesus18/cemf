...
<div class="container-xxl  ">
    ...
    <div class="row justify-content-center align-items-center g-2">
        <div class="col">
            <h1 class="float-start">Anexos de Lançamentos</h1>
        </div>
    </div>
                ...
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title h1 text-center" id="TituloModalCentralizado">Adicionar Anexo</h5>
                        ...
                        <div class="modal-body">
                            <div class="container-xxl">
                                <div class="authentication-wrapper authentication-basic container-p-y">
                                    ...
                                    <form class="" action="launchAttachments" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-xl">
                                                <div class="card-body">
...
<div class="table-responsive m-3">
    <table class="table">
        ...
        <tbody>
            @forelse ($launchAttachment as $launchAttachments)
            <tr class="">

                <td scope="row">
                    <a href="{{ asset('image/launchAttachments/' . $launchAttachments->file) }}" target="_blank">
                        <img src="{{ asset('image/launchAttachments/' . $launchAttachments->file) }}" alt="{{ $launchAttachments->title }}" style="width: 150px; height: auto;">
                    </a>
                </td>
                <td>{{$launchAttachments->title}}</td>
                <td>
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu dropdown-menu-start" aria-labelledby="triggerId">
                            <form action="{{ route('launchAttachments.destroy', $launchAttachments) }}" method="post">
                                @csrf
                                @method('DELETE')
