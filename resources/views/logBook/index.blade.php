...
<div class="container-xxl">
                        ...
                        <div class="modal-body">
                            <div class="container-xxl">
                                <div class="authentication-wrapper authentication-basic container-p-y">
                                    <form class="" action="logBooks" method="POST">
                                        @csrf
                                        <div class="row">
                                            <div class="col-xl">
                                                <div class="card-body">
    ...
    <div class="table-responsive m-3">
        <table class="table">
            ...
            <tbody>
                @forelse ($logBook as $logBooks)
                <tr class="">
                    <td scope="row">{{ $logBooks->id }}</td>
                    <td scope="row">{{ $logBooks->title }}</td>
                    <td>
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-start" aria-labelledby="triggerId">
                                <form action="{{ route('logBooks.destroy', $logBooks) }}" method="post">
                                    @csrf
                                    @method('DELETE')
