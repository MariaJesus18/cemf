        ...
        <div class="col-8">
            <form action="" class="form-group ">
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Buscar disciplinas..." aria-describedby="button-addon1">
                </div>
            </form>
        </div>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-start" aria-labelledby="triggerId">
                                ...
                                <a class="dropdown-item" href="{{ route('typeReleases.edit', $typeReleases->id) }}">Editar</a>
